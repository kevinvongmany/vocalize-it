    ...
    <div className="md:mt-20 md:px-20">
      <main className="border rounded-xl p-4 bg-indigo-950 max-w-[1200px] mx-2 md:mx-auto">
        ...
        <section className="container">
          ...
          <div className="grid">
            <section>
              <textarea
                id="ttsUserInput"
                name="bio"
                placeholder="Write some text htmlFor Codey to read..."
          ...
          <details>
            ...
            <div className="container-fluid centered">
              ...
              <div className="">
                ...
                <input type="range" id="pitch" min="0" max="2" step="0.5" value={pitch} onChange={(e) => setPitch(e.target.value)} />
              </div>
            </div>
          </details>
          ...
          <button id="ttsBtn" className="container-fluid">
            Read!
          </button>
        </section>
      </main>
